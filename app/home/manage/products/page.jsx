...
export default function UsersPage(){
    const { data: deliveryTypesData } = useSWR('http://localhost:5000/delivery_types', fetcher)
    const { data: productStatusesData } = useSWR('http://localhost:5000/product_statuses', fetcher)
    const { data: paymentTypes} = useSWR('http://localhost:5000/payment_types', fetcher)
    const { data: unitTypesData,error,isLoading } = useSWR('http://localhost:5000/unit_types', fetcher)
                        ...
                        <div className='flex flex-col gap-2 w-full'>
                            <h2 className='text-xl font-semibold'>Способы доставки :</h2>
                                <form name='unit-type' className='relative flex-row-center'>
                                    ...
                                    ></input>
                                    <button name='unit-type' onClick={handleDeliveryTypeSubmit} type='submit' className='icons-wrapper center absolute right-0'>
                            ...
                            <h2 className='text-xl font-semibold'>Статус продукта :</h2>
                                <form name='unit-type' className='relative flex-row-center'>
                                    <input
                                        ...
                                        className='input-outline px-4 h-10 w-full'
                                    ></input>
                                    <button name='unit-type' onClick={handleProductStatusSubmit} type='submit' className='icons-wrapper center absolute right-0'>
                                        <HiOutlinePlusSm className='icons'/>
                                    </button>
                                </form>
                            <div className='flex flex-col gap-2 h-auto w-full'>
                        ...
                        <div className='flex flex-col gap-2 w-full'>
                            ...
                            <form name='unit-type' className='relative flex-row-center'>
                                <input
                                    ...
                                    className='input-outline px-4 h-10 w-full'
                                ></input>
                                <button name='unit-type' onClick={handleUnitTypeSubmit} type='submit' className='icons-wrapper center absolute right-0'>
                                    <HiOutlinePlusSm className='icons'/>
                                </button>
                            </form>
                            <div className='flex flex-col gap-2 h-auto w-full'>
                            ...
                            <h2 className='text-xl font-semibold'>Способы оплаты :</h2>
                                <form name='unit-type' className='relative flex-row-center'>
                                    <input
                                        ...
                                        className='input-outline px-4 h-10 w-full'
                                    ></input>
                                    <button name='unit-type' onClick={handlePaymentTypeSubmit} type='submit' className='icons-wrapper center absolute right-0'>
                                        <HiOutlinePlusSm className='icons'/>
                                    </button>
                                </form>
                            <div className='flex flex-col gap-2 h-auto w-full'>
