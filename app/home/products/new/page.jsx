...
import Selector from 'components/Functions/Selector'
...
export default function NewProductPage(){
    ...
    const { data: categories } = useSWR('http://localhost:5000/categories',fetcher)
    const { data: countries } = useSWR('http://localhost:5000/countries',fetcher)
    const { data: product_statuses } = useSWR('http://localhost:5000/product_statuses',fetcher)
    const { data: unit_types, isLoading, error } = useSWR('http://localhost:5000/unit_types',fetcher)
        ...
        <form className='flex flex-col gap-4' encType='multipart/form-data'>
            ...
            <div className='flex flex-col gap-2 md:flex md:flex-row md:gap-4'>
                ...
                <div className='border rounded-lg text-center center flex-col gap-4 p-2 md:flex-[50%] md:max-w-[50%] w-full'>
                    ...
                    <div className={selectedFiles.length > 0 ? 'relative block min-h-[360px] md:max-h-[500px] w-full' : 'hidden relative h-72'}>
